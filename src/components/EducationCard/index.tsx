    ...
    <div className="bg-orange-200 pl-1 rounded-lg border-[#C38A48] min-w-50 border-1 shadow-sm">
            <div className="flex flex-col gap-1.25 text-nowrap  items-start bg-white p-2.5 rounded-lg">
              <div className="flex flex-1 w-full justify-between items-center">
                ...
                <span className="border-1 border-[#8AE82B] text-[#5D7237] text-[0.8rem] rounded-md px-1.75 py-0.25 bg-[#CAFF74]">Concluído</span>
              </div>
              <div className="flex flex-col gap-1">
                <p className="flex gap-1 text-[#7A6E50]">
                  <span className="font-medium text-[#C38A48] px-1 py 0.5 border-[#FFC396] border-1 rounded-md">{acronym}</span>
                  {fullName}
                </p>
